...
public class SOLKafkaProducer extends KafkaProducer {
  private static final Logger LOG = LoggerFactory.getLogger(SOLKafkaProducer.class);
  ...
  public StormTopology getTopology(Config config) {
    ...
    setSpout(new RandomMessageSpout(msgSize, false));
